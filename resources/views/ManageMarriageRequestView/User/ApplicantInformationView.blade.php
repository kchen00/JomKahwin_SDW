...
@section('ManageMarriageRequestView.User.ApplicantInformationView')
            ...
            <div class="container-fluid">
                ...
                <div class="header">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="dashboard-default.html">Maklumat Pemohon</a></li>
                            <li class="breadcrumb-item"><a href="#">Maklumat Pasangan</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Maklumat Perkahwinan</li>
                        </ol>
                    </nav>
                </div>
                <div class="row">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab-1" role="tabpanel">
                                    ...
                                    <form>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-3">
                                                <select class="form-select" id="bangsa" name="bangsa"
                                                    class="form-control">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-3">
                                                <select class="form-select" id="WARGANEGARA" name="Tahun"
                                                    class="form-control">
                                                    <option value="">-Sila Pilih-</option>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <span class="form-check-label">Tanda Jika Alamat Semasa Sama Dengan Alamat
                                                    Dalam
                                                    K/P</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3 row">
                                            <label class="col-form-label col-sm-2 text-sm-end">No Telefon (Bimbit) :
                                            </label>
                                            <div class="col-sm-3">
                                                <input type="kad" class="form-control">
                                            </div>
                                        ...
                                        <div class="mb-3 row">
                                            <label class="col-form-label col-sm-2 text-sm-end">No Telefon (Rumah) :
                                            </label>
                                            <div class="col-sm-3">
                                                <input type="kad" class="form-control">
                                            </div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-3">
                                                <select class="form-select" id="taraf" name="taraf"
                                                    class="form-control">
                                                    <option value="">-Sila Pilih-</option>
                                        ...
                                        <div class="mb-3 row">
                                            <label class="col-form-label col-sm-2 text-sm-end">Status Saudara Baru :
                                            </label>
                                            <div class="col-sm-3">
                                                <select class="form-select" id="saudara" name="saudara"
                                                    class="form-control">
                                                    <option value="">-Sila Pilih-</option>
                                ...
                                <div class="tab-pane" id="tab-3" role="tabpane3">
                                    ...
                                    <form>
                                        ...
                                        <div class="mb-3 row">
                                            <label class="col-form-label col-sm-2 text-sm-end">Tempat Kahwin(Negara):
                                            </label>
                                            <div class="col-sm-3">
                                                <input type="kad" class="form-control">
                                            </div>
                                        ...
                                        <div class="text-center">
                                            <h5 class="tab-title">MAKLUMAT CADANGAN MAJLIS AKAD NIKAH</h5>
                                            <hr>
                                        </div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="date" id="txtTkhNikah" name="txtTkhNikah"
                                                    class="form-control" required>
                                            </div>
                                        </div>

                                        <div class="mb-3 row">
                                            <label class="col-form-label col-sm-2 text-sm-end">Alamat Tempat Kahwin:
                                            </label>
                                            <div class="col-sm-3">
                                                <input type="kad" class="form-control">
                                            </div>
                                        ...
                                        <div class="text-center">
                                            <h5 class="tab-title">MAKLUMAT WALI</h5>
                                            <hr>
                                        </div>
                                        ...
                                        <div class="mb-3 row">
                                            <label class="col-form-label col-sm-2 text-sm-end">Tarikh Nikah Ibu Bapa :
                                            </label>
                                            <div class="col-sm-3">
                                                <input type="date" id="txtTkhNikah" name="txtTkhNikah"
                                                    class="form-control" required>
                                        ...
                                        <div class="text-center">
                                            <h5 class="tab-title">MAKLUMAT SAKSI (1)</h5>
                                            <hr>
                                        </div>
                                        ...
                                        <div class="text-center">
                                            <h5 class="tab-title">MAKLUMAT SAKSI (2)</h5>
                                            <hr>
                                        </div>
                                        ...
                                        <div class="col-sm-17 ms-sm-auto" style="display: flex; justify-content: center; align-items: center;">
                                            ...
                                            <a href="daftar" class= "btn btn-primary mr-6 ">Kembali</button></a>&nbsp;&nbsp;
                                            <a href="wali" class= "btn btn-primary mr">Seterusnya</button></a>&nbsp;&nbsp;
                                            {{-- <button type="submit" class="btn btn-primary mr-6 ">Kembali</button>&nbsp;&nbsp;
                                            <button type="submit" class="btn btn-primary">Seterusnya</button>&nbsp;&nbsp; --}}
