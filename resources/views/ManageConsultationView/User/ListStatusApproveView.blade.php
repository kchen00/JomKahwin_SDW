...
@section('ManageConsultationView.User.ListStatusApproveView')
        ...
        <div class="card">
            ...
            <table bgcolor="#2F72B9" cellpadding="0" cellspacing="1" align="center" width="100%">
                ...
                <td>
                    ...
                    <a href="consultSession" class="btn btn-primary">Sesi Khidmat Nasihat</a>
                </td>
                </tr> 
			</table><br>
            
            <div class="card-body" style="text-align: center;">
            <p style="color:#192D95;"><b><i>Nota: Sila klik Sesi Khidmat Nasihat untuk maklumat sesi khidmat nasihat anda</i></b></p> <br>  
