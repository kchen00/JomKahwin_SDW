...
@section('ManageConsultationView.User.UpdateApplicationView')
...
<div class="header">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Kemaskini Pendaftaran</li>
        </ol>
    </nav>
</div>
                ...
                <div id="maklumat-pengadu" class="tab-pane" role="tabpanel">
                    <div class="col-md-12">
                        ...
                        <form>
                                    ...
                                    <input type="date" class="form-control" id="birthdatePengadu" name="birthdatePengadu">

                                    <label for="bangsaPengadu">Bangsa</label>
                                    <input type="text" class="form-control" id="bangsaPengadu" name="bangsaPengadu">

                                    <label for="jobPengadu">Sektor Pekerjaan</label>
                                    <input type="text" class="form-control" id="jobPengadu" name="jobPengadu">
                    ...
                    <div class="col-md-12">
                        <div class="card-body">
                            <form>
                                    ...
                                    <input type="date" class="form-control" id="birthdateKeneAdu" name="birthdateKeneAdu">

                                    <label for="bangsaKeneAdu">Bangsa</label>
                                    <input type="text" class="form-control" id="bangsaKeneAdu" name="bangsaKeneAdu">

                                    <label for="jobKeneAdu">Sektor Pekerjaan</label>
                                    <input type="text" class="form-control" id="jobKeneAdu" name="jobKeneAdu">
                            ...
                            <div style="text-align: center;">
                                <a href="listStatusApprove" class="btn btn-primary">Hantar</a>
                            </div>
                    </div>
                </div>
            </div>
