...
<body>
    <div class="wrapper" >
		<nav id="sidebar" class="sidebar">
			...
			<div class="sidebar-content">
				...
				<ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
						<a class="sidebar-link" href="manageConsultation">
		...
		<div class="main">
					...
					<ul class="navbar-nav ms-auto">
						<li class="nav-item dropdown ms-lg-2">
							<a href="/logout" class="text-light">
								<i class="align-middle me-2 text-light" data-feather="log-out"></i>keluar
							</a>
						</li>
					</ul>
				</div>
			...
			<main class="content" >
				<div class="p-4 card block w-full">
					<p>Selamat Datang ke Sistem Jom Kahwin</p>
					<p>{{ now() }}</p>
				</div>
				<div class="container-fluid" >
					...
					@yield("ManageProfileView.ManageProfileUpdateView")
					</div>
			</main>
