...
@section('ManageMarriagePrepCourseView.Admin.daftarKehadiranView')
                        ...
                        <div class="col-12 col-xl-6">
                            <div class="card">
                                ...
                                <div class="col-sm-17 ms-sm-auto"
                                    ...
                                    <a href="peserta" class= "btn btn-primary mr-6 ">Kembali</button></a>&nbsp;&nbsp;
                                    <a href="ke" class= "btn btn-primary mr-6 ">Seterusnya</button>&nbsp;&nbsp;</a>
