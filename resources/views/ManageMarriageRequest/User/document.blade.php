...
<div class="col-6 col-lg-12">
    <div class="tab">
        <ul class="nav nav-tabs" role="tablist">
            <li class="nav-item"><a class="nav-link active" href="#tab-1" data-bs-toggle="tab" role="tab">PERSETUJUAN WALI DAN WAKALAH WALI</a></li>
            <li class="nav-item"><a class="nav-link" href="#tab-2" data-bs-toggle="tab" role="tab">UJIAN SARINGAN HIV</a></li>
            <li class="nav-item"><a class="nav-link" href="#tab-3" data-bs-toggle="tab" role="tab">AKUAN PEMASTAUTINAN</a></li>
        </ul>
        <div class="tab-content">
            <div class="tab-pane active" id="tab-1" role="tabpanel">
                <h4 class="tab-title">PERSETUJUAN WALI</h4>
                <a href="/SEM4/e-munakahat documents/Borang Persetujuan Wakalah Wali.pdf" download>Download Form</a>
