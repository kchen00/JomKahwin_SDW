    ...
    <div class="col-5 col-xl-12">
        <div class="card">
            ...
            <div class="card-body">
                <form>
                    <div class="mb-3 row">
                        <label class="col-form-label col-sm-2 text-sm-end">Tempat <font color="#FF0000"> *</font> : </label>
                        <div class="col-sm-10">
                    ...
                    <div class="mb-3 row">
                        <label class="col-form-label col-sm-2 text-sm-end">Alamat <font color="#FF0000"> *</font> : </label>
                        <div class="col-sm-10">
